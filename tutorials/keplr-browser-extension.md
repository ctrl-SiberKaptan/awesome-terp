...
{% hint style="success" %}
**For people who have stakedrop** ([http://stakedrop.terp.network](http://stakedrop.terp.network) to confirm):

If you do not already have the account associated with TerpNet loaded into your Keplr wallet, please proceed to [Import existing account](keplr-browser-extension.md#import-an-existing-account) and use the "Mnemonic Seed" associated with your Cosmos (ATOM) account that is compatable with Keplr. Or, if your Cosmos account was secured by a ledger hardware wallet, please proceed to[ Import ledger](keplr-browser-extension.md#import-ledger).
{% endhint %}
